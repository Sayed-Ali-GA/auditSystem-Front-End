...
const AuditsList = () => {
  ...
  const canDelete = roleId === 1; // Admin only
  ...
  // =====================================================
  // LOAD AUDITS (always active — no more archive view)
  // =====================================================
  ...
  // =====================================================
  // DELETE AUDIT — PERMANENT
  // =====================================================
  const handleDelete = async (id) => {
    const result = await Swal.fire({
      title: "Delete this audit permanently?",
      text: "This cannot be undone. The audit, all its findings, ratings, and related notifications will be permanently removed.",
      icon: "warning",
    ...
    try {
      ...
      notify("success", "Audit permanently deleted.");
    } catch (err) {
